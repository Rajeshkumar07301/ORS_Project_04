...
import in.co.pro4.util.EmailBuilder;
import in.co.pro4.util.EmailMessage;
import in.co.pro4.util.EmailUtility;
...
public class UserModel {
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		String sql = "UPDATE ST_USER SET FIRST_NAME=?,LAST_NAME=?,LOGIN=?,PASSWORD=?,DOB=?,MOBILE_NO=?,ROLE_ID=?,UNSUCCESSFULL_LOGIN=?,GENDER=?,LAST_LOGIN=?,USER_LOCK=?,REGISTERED_IP=?,LAST_LOGIN_IP=?,CREATED_BY=?,MODIFIED_BY=?,CREATED_DATETIME=?,MODIFIED_DATETIME=?  WHERE ID=?";
		Connection conn = null;
		UserBean existBean = findByLogin(bean.getLogin());
