...
public class LoginCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_LOG_OUT.equals(op) && !OP_SIGN_IN.equals(op)) {
			// System.out.println("Do log out is working");
		...
		// System.out.println("Do get chalegi");
		ServletUtility.forward(getView(), request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SIGN_IN.equalsIgnoreCase(op)) {
			// System.out.println(" Lctl Do post 123456");
			...
			try {
				...
				if (bean != null) {
					...
					// System.out.println(" Loginctl Do post1 ");
			...
			// System.out.println("Loginctl Do post2 ");
