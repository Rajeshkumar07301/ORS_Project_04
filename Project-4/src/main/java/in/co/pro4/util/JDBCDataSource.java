...
public class JDBCDataSource {
	...
	public static JDBCDataSource getInstance() {
		if(datasource == null) {
			ResourceBundle rb = ResourceBundle.getBundle("in.co.pro4.bundle.system");
			...
			try {
				...
				datasource.cpds.setAcquireIncrement(new Integer((String)rb.getString("acquirelncrement")));
